package io.openems.edge.tesla.powerwall2.battery.custom;
...
import io.openems.edge.tesla.powerwall2.core.custom.TeslaPowerwall2Core;

@Designate(ocd = Config.class, factory = true)
@Component(//
		name = "Tesla.Powerwall2.Battery.Custom", //
		immediate = true, //
