...
import io.openems.edge.tesla.powerwall2.battery.custom.TeslaPowerwall2Battery;

@Designate(ocd = Config.class, factory = true)
@Component(//
		name = "Tesla.Powerwall2.Core.Custom", //
		immediate = true, //
...
public class TeslaPowerwall2CoreImpl extends AbstractOpenemsComponent
	...
	void activate(ComponentContext context, Config config)
		...
		this.worker = new ReadWorker(this, (Inet4Address) InetAddress.getByName(config.ipAddress()), config.port(), config.username(), config.password());
