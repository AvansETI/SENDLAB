...
public interface V2G extends OpenemsComponent, EventHandler {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		POWER_UNIT_TEMPERATURE(Doc.of(OpenemsType.DOUBLE).unit(Unit.DEGREE_CELSIUS).accessMode(AccessMode.READ_WRITE)
				.persistencePriority(PersistencePriority.HIGH)),
	...
	public default DoubleWriteChannel getPowerUnitTemperatureChannel() {
		return this.channel(ChannelId.POWER_UNIT_TEMPERATURE);
	}
