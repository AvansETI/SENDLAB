      ...
      try:
          ...
          data = {
            ...
            "measurements": [{
                ...
                "vol_d0_t2":            float(records[6]["value"]),
                "vol_d0_t3":            float(records[7]["value"]),
                "op_on_time":           float(records[8]["value"]),
                "err_on_time":          float(records[9]["value"]),
                "flow_temp_in":         float(records[10]["value"]),
                "flow_temp_out":        float(records[11]["value"]),
                "temp_diff":            float(records[12]["value"]),
                "act_pow":              float(records[13]["value"]),
                "max_pow":              float(records[14]["value"]),
                "act_vol_flow":         float(records[15]["value"]),
                "max_vol_flow":         float(records[16]["value"]),
                "heat_energy_targ":     float(records[19]["value"]),
                "cool_energy_targ":     float(records[20]["value"]),
                "vol_d1_t0_targ":       float(records[21]["value"]),
                "vol_d2_t0_targ":       float(records[22]["value"]),
                "vol_d0_t1_targ":       float(records[23]["value"]),
                "vol_d0_t2_targ":       float(records[24]["value"]),
                "vol_d0_t3_targ":       float(records[25]["value"]),
                "max_pow_targ":         float(records[26]["value"]),
